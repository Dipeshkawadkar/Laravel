                ...
                <div class="row">
                    <div class="col-lg-9">
                            ...
                            <p class="p22">Because of the remote nature of our trips and their length, we like to talk with all of our guests before the trip. But if you can’t wait to sign up, send us a Reservation Form and we will contact you shortly to confirm trip details, answer your questions, and make sure you are going to have the trip of a lifetime.</p><br>
                              ...
                              <div>
<div class="container">
  <form action="/contact" method="POST" class ="jumbotron">
{{ csrf_field()}}
  ...
  <!--   <div class="form-group">
   ...
   -->  <div class="form-group">
      <label for="phon">Mobile Number:</label>
      <input type="text" class="form-control" id="phon" placeholder="Enter Mobile " name="phon">
    </div>
    <div class="form-group">
      <label for="phone">Number in your party:</label>
      <input type="text" class="form-control" id="phone" placeholder="Number of people" name="phone">
    </div>
    <div class="checkbox">
